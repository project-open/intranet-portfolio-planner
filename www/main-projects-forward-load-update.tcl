...
foreach project_json_object $json_list {
    ...
    # ---------------------------------------------------------
    # Start a notification workflow for each project to inform
    # the Project Admins about the changes.
    # See intranet-portfolio-planner-workflow-create.sql for doc.
    set context_key ""
    set wf_key "portfolio_planner_change_wf"
    set case_id [wf_case_new $wf_key $context_key $project_id]
